  ...
  Future<void> _load() async {
    ...
    if (loadImage || loadText) {
      try {
        ...
        // Fall through to the provider thumbnail instead of opening a browser.
      }
    }
    ...
    try {
      ...
      setState(() {
        ...
        if (_isText && size != null && size > _maxTextBytes) {
          ...
          _message = 'A full in-app content preview is not available for this file type.';
        }
      });
    } catch (_) {
      if (!mounted || request != _request) return;
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'No visual preview is available for this format. Double-click to open the provider view in your browser.',
